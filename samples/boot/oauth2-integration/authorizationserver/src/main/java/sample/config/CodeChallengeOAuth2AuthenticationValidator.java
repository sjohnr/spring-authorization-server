 ...
 * @author Joe Grandja
 */
class CodeChallengeOAuth2AuthenticationValidator implements OAuth2AuthenticationValidator {
	...
	public void validate(OAuth2AuthenticationContext authenticationContext) {
		...
		// See default validator:
		// OAuth2AuthorizationCodeRequestAuthenticationProvider.DefaultCodeChallengeOAuth2AuthenticationValidator
