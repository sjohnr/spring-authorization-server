 ...
 * @author Joe Grandja
 */
class ScopeOAuth2AuthenticationValidator implements OAuth2AuthenticationValidator {
	...
	public void validate(OAuth2AuthenticationContext authenticationContext) {
		...
		// OAuth2AuthorizationCodeRequestAuthenticationProvider.DefaultScopeOAuth2AuthenticationValidator
