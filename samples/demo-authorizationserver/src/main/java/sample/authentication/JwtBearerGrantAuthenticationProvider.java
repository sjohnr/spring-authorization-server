...
public final class JwtBearerGrantAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		JwtBearerGrantAuthenticationToken jwtBearerGrantAuthentication =
				(JwtBearerGrantAuthenticationToken) authentication;

		OAuth2ClientAuthenticationToken clientPrincipal =
				getAuthenticatedClientElseThrowInvalidClient(jwtBearerGrantAuthentication);
		RegisteredClient registeredClient = clientPrincipal.getRegisteredClient();

		OAuth2Authorization authorization = this.authorizationService.findByToken(
				jwtBearerGrantAuthentication.getAssertion(), OAuth2TokenType.ACCESS_TOKEN);
